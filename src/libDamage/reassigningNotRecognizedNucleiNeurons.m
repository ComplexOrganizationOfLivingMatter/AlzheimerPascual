...
%%REASSIGNINGNOTRECOGNIZEDNUCLEINEURONS 
% Exist some nuclei+neurons within a neuron unassigned with a circle, we
% are going to assigned them to a neuron.
    ...
    % Removing the assigned nucleis+neurons from red circles
    idNeurons2delete=[];
